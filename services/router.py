...
class SmartRouter:
    ...
    async def route_and_process_streaming(self, chat_request: ChatRequest, auth_header: str) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            yield "data: [DONE]\n\n"
            logger.info(f"✅ Streaming response completed successfully")
