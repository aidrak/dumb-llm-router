...
import base64
from typing import Any, AsyncGenerator, Dict, List, Optional  # ADD AsyncGenerator HERE
...
class GeminiWithPerplexityClient(BaseLLMClient):
    ...
    async def _call_perplexity_search(self, query: str, perplexity_config: Dict[str, Any]) -> str:
        ...
        payload = {
            ...
            "messages": [
                {
                    "role": "system",
                    "content": "You are a helpful research assistant. Provide comprehensive and accurate information, citing your sources.",
                },
    ...
    def _create_search_function_declaration(
        self, perplexity_config: Dict[str, Any]
        ...
        properties = {
            "query": types.Schema(
                type=types.Type.STRING, description="The search query to find relevant information"
            )
        }
        ...
        return types.FunctionDeclaration(
            ...
            parameters=types.Schema(
                type=types.Type.OBJECT, properties=properties, required=["query"]
            ),
        )
                    ...
                    if function_calls:
                        ...
                        for func_call in function_calls:
                            ...
                            if hasattr(func_call, "name") and func_call.name == function_name:
                                if hasattr(func_call, "args"):
                                    ...
                                    domain_filter = None
                                    if args:
                                        domain_filter = args.get(
                                            "domain_filter"
                                        ) or perplexity_config.get("search_domain_filter")
                                    else:
                                        domain_filter = perplexity_config.get(
                                    ...
                                    if query:
                                        ...
                                        search_result = await self._call_perplexity_search(
                                            query, perplexity_config
                                        )
                                        ...
                                        logger.warning(
                                            "🔍 Function call received but no query found"
                                        )
                                else:
                        ...
                        if function_responses:
                            ...
                            final_response = self.client.models.generate_content(
                                model=model_id, contents=updated_contents, **generate_params
                            )

                            logger.info("✅ Generated enhanced response with search results")
                            return {
                ...
                if hasattr(candidate, "content") and hasattr(candidate.content, "parts"):
                    ...
                    if function_calls_made and enable_perplexity_search:
                        ...
                        if function_responses:
                            ...
                            logger.info(
                                "✅ Started streaming enhanced response with search results"
                            )
